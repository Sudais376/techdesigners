    ...
    <>
     ...
     {modalImage && (
      ...
      <section data-aos="fade-up">
        ...
        <div data-aos="fade-up" className="flex flex-wrap justify-center gap-8 py-12 px-6">
          ...
          >
            ...
            {showBio.sudais && (
              <div data-aos="fade-up" className="bio mt-4">
                ...
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio soluta dolores odio!
                Excepturi quod laboriosam enim aliquid cumque sit distinctio explicabo alias
                adipisci officia vero expedita facere, pariatur esse quibusdam id voluptatem eveniet
                porro ullam quos soluta nesciunt officiis temporibus.
              </div>
            )}
          </div>
          ...
          >
            ...
            {showBio.saad && (
              <div data-aos="fade-up" className="bio mt-4">
                {/* Biography text for Muhammad Saad */}
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio soluta dolores odio!
                Excepturi quod laboriosam enim aliquid cumque sit distinctio explicabo alias
                adipisci officia vero expedita facere, pariatur esse quibusdam id voluptatem eveniet
                porro ullam quos soluta nesciunt officiis temporibus.
